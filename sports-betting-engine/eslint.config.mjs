...
export default [{
  files:['src/services/college*.ts','src/services/nflPaper.ts','src/services/footballGuardrail.ts','src/services/footballValidation.ts',
    'src/services/closingLineTracker.ts','src/services/nflContext*.ts','src/services/nflDailyRun.ts','src/services/nflReadiness.ts',
    'src/dev/college*.ts','src/dev/nflContextAudit.ts','src/tests/college*.ts','src/tests/nflContext*.ts','src/tests/nflDailyRun.test.ts','server.ts','public/college-markets.js','public/nfl-markets.js'],
