...
Generated: 2026-09-07T18:00:00.000Z
...
| B1_OPPONENT_ADJUSTED_MARGIN | undefined | 15.709 | 20.021 | -0.889 |
| B2_PRESEASON_CURRENT_BLEND | undefined | 16.300 | 20.675 | -0.916 |
| B3_NONLINEAR_MISMATCH | undefined | 16.353 | 20.710 | -1.520 |
...
No validated FBS/FCS methodology emerged. Future FBS/FCS projections must be treated as MODEL_UNAVAILABLE rather than patched with arbitrary points.

## J. Feature ablation

| Ablation | N | MAE | RMSE | Bias | Interpretation |
|---|---:|---:|---:|---:|---|
| Selected model (reference) | undefined | 15.709 | 20.021 | -0.889 | Locked 2025 reference. |
| Remove home-field | undefined | 16.233 | 21.065 | 6.612 | Forces every target venue neutral; training remains chronological. |
...
Recorded after command completion in manifest/test-results.json. Research implementation does not change production.
