...
The pilot used **81 Odds API credits**: one discovery plus two four-market historical pulls. Remaining immediately afterward: 19,857. College browser QA subsequently used two more credits; its repeat used the cache. Historical market access and charging are described in the [provider documentation](https://the-odds-api.com/historical-odds-data/).
