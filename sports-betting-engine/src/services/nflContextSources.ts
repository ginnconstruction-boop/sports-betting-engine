...
export type NflContextCategory='GAME_IDENTITY'|'CURRENT_SEASON'|'ROSTER'|'QB_ROLE'|'INJURIES'|'WEATHER'|'GAME_AVAILABILITY'|'OPPONENT_QUALITY';
...
const definitions:NflContextSourceState[]=[
  ...
  {id:'nfl-injury-report:INJURIES',category:'INJURIES',sourceName:'Official NFL weekly injury report',sourceType:'OFFICIAL_PROVIDER',sourceTier:1,enabled:true,configured:true,credentialsRequired:false,credentialsPresent:true,refreshInterval:'15 minutes in game week',lastAttempt:null,lastSuccess:null,lastFailure:null,failureReason:null,lastResult:'NO_SOURCE_ATTEMPTED'},
  {id:'nflverse-team-stats:OPPONENT_QUALITY',category:'OPPONENT_QUALITY',sourceName:'nflverse weekly team statistics (CC-BY-4.0)',sourceType:'PUBLIC_PROVIDER',sourceTier:3,enabled:true,configured:true,credentialsRequired:false,credentialsPresent:true,refreshInterval:'6 hours',lastAttempt:null,lastSuccess:null,lastFailure:null,failureReason:null,lastResult:'NO_SOURCE_ATTEMPTED'},
  ...
  {id:'official-inactives:GAME_AVAILABILITY',category:'GAME_AVAILABILITY',sourceName:'Official NFL game-day inactives',sourceType:'OFFICIAL_PROVIDER',sourceTier:1,enabled:false,configured:false,credentialsRequired:false,credentialsPresent:false,refreshInterval:'near kickoff',lastAttempt:null,lastSuccess:null,lastFailure:null,failureReason:'The free NFL.com inactives page is identified; its live player structure must be verified before automation',lastResult:'NO_PROVIDER_CONFIGURED'},
];
